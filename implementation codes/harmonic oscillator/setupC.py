...
# Please rewrite the following arguments based on your OS and your prescription of compilation
# Please refer to https://software.intel.com/en-us/articles/intel-mkl-link-line-advisor . Usually Python uses GCC as the default compiler, and then GNU compiler should be selected. The arguments starting with "-I" mean to "include" those directories, and they are handled in line 44 of this file.
...
def compile(n_max, omega, gamma):
    ...
    if original_args_exist: sys.argv = sys.argv+original_args
    else: sys.argv.pop(1)
